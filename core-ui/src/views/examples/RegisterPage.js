...
export default function RegisterPage() {  
  ...
  const [yearsOfExperienceFocus, setyearsOfExperienceFocus] = React.useState(false);
  const [emailFocus, setEmailFocus] = React.useState(false);
  const [userResidingCityFocus , setUserResidingCityFocus] = React.useState(false);
  ...
  const [userCurrentCompanyFocus, setUserCurrentCompanyFocus] = React.useState(false);
  ...
  const varTemp = { "name": fullNameValue,
  "state": userState,
...
const  updateUserState= (e)=>{setUserState(e.target.userState);}

  const JoinUsHandler = async () =>{
    console.log("JOinUs Handler initialted.",varTemp);
    await axios.post("http://localhost:3001/join-community",{   "obj":{
      "name": fullNameValue,
      "state": userState,
      "city": userResidingCity,
      "yearsOfExperience": userYearsOfExperience,
              ...
              <Row>
                <Col className="offset-lg-0 offset-md-3" lg="5" md="6">
                  ...
                  <Card className="card-register" style={{width:"350px"}}>
                      ...
                      <Form className="form">
                        ...
                        >
                          ...
                          <Input
                            ...
                            onChange={(e)=>{setFullNameValue(e.target.value); console.log(e.target.value)}}
                          />
                        </InputGroup>
                        ...
                        >
                          ...
                          <Input
                            ...
                            onChange={(e)=>{setuserResidingCity(e.target.value)}}
                          />
                        </InputGroup>
                        ...
                        >
                          ...
                          <Input
                            ...
                            onChange={(e)=>{setUserYearssOfExperience(e.target.value)}}
                          />
                        </InputGroup>
                        ...
                        >
                          ...
                          <Input
                            ...
                            onChange={(e)=>{setUserResumeLink(e.target.value)}}
                          />
                        </InputGroup>

                        <FormGroup check className="text-left">
                          <Label check>
                            <Input type="checkbox" onClick={()=> {setTermsAndConditions(!termsAndConditions)}}/>
                    ...
                    <CardFooter>
                      <Button className="btn-round" color="primary" size="lg" onClick={()=> AddUserJoinUs()}>
                        Join US!
                      </Button>
                    </CardFooter>
                  </Card>
